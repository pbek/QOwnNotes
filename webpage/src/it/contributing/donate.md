...
Potete **inviare denaro via PayPal** cliccando qui:
...
Potete **inviare denaro via Liberapay** cliccando qui:
...
Potete **donare bitcoin (BTC)** al seguente conto bitcoin BTC:

```
395NiU7QKpNiayWgRrUEGZDn8Z1ebMx8CH
```

Potete **donare bitcoin (Cash)** al seguente conto bitcoin Cash:
...
Potete **donare Ethereum (ETH)** al seguente conto Ethereum ETH:

```
0x992aD2066640C5bF175c7c5649a41827dF6f87C9
```

Potete **donare Ethereum (ETC)** al seguente conto Ethereum ETC:
