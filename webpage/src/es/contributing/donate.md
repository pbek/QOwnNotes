...
Puede **donar dinero a través de PayPal** haciendo clic en este botón:
...
Puede **donar dinero a través de Liberapay** haciendo clic en este botón:
...
Puede **donar Bitcoin BTC** a esta dirección de Bitcoin BTC:

```
395NiU7QKpNiayWgRrUEGZDn8Z1ebMx8CH
```

Puede **donar Bitcoin Cash** a esta dirección de Bitcoin Cash:
