...
::: warning
إذا أردت استخدام **التحديث التلقائي** فنرجو التأكد من استخراجه إلى مكان مسموح لحسابك بالكتابة فيه. غالبًا ليس لحسابك **إذن الكتابة** في مجلدات مثل `C:\Program Files (x86)`أو `C:\Program Files`.
:::
