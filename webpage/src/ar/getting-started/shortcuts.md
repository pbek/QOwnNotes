...
- <kbd>Ctrl</kbd> + <kbd>Space</kbd> يحاول حل معادلات بسيطة مثل `(4+5)*3=`أمام المؤشر، أو يكمل النص تلقائيا، أو يفتح الرابط
...
- <kbd>⌘ Cmd</kbd> + <kbd>Space</kbd> يحاول حل معادلات بسيطة مثل `(4+5)*3=`أمام المؤشر، أو يكمل النص تلقائيا، أو يفتح الرابط
