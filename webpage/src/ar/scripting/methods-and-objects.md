...
ربما تحب أن تلقي نظرة على مثال البُريمچ [scripting-label-demo.qml](https://github.com/pbek/QOwnNotes/blob/main/docs/scripting/examples/scripting-label-demo.qml).
