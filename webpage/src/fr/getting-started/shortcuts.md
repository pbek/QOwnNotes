...
- <kbd>Ctrl</kbd> + <kbd>⇧</kbd> + <kbd>L</kbd> ouvre une boîte de dialogue pour ajouter un lien vers une note
...
- <kbd>Ctrl</kbd> + <kbd>⇧</kbd> + <kbd>B</kbd> insère un bloc de citation à la position actuelle
...
- <kbd>Ctrl</kbd> + <kbd>⇧</kbd> + <kbd>U</kbd> fait défiler les casses du texte sélectionné
- <kbd>Tab</kbd> indente le texte sélectionné (fonctionne également sur plusieurs lignes)
    - <kbd>⇧</kbd> + <kbd>Tab</kbd> désindente texte sélectionné
...
- <kbd>Ctrl</kbd> + <kbd>⇧</kbd> + <kbd>H</kbd> insère comme titre, en haut de la note, le nom de fichier de la note
...
- <kbd>Ctrl</kbd> + <kbd>⇧</kbd> + <kbd>Flèche bas</kbd> déplace la ligne actuelle vers le bas
- <kbd>Ctrl</kbd> + <kbd>⇧</kbd> + <kbd>Flèche haut</kbd> déplace la ligne actuelle vers le haut
...
- <kbd>Alt</kbd> + <kbd>⇧</kbd> + <kbd>P</kbd> bascule vers l'espace de travail précédent
...
- <kbd>⌘</kbd> + <kbd>⇧</kbd> + <kbd>O</kbd> ouvre la note actuelle dans un éditeur externe
...
- <kbd>⌘</kbd> + <kbd>⇧</kbd> + <kbd>D</kbd> bascule vers le mode sans distraction
    - vous pouvez également le fermer avec <kbd>Esc</kbd>
...
- <kbd>Ctrl</kbd> + <kbd>⇧</kbd> + <kbd>A</kbd> ajoute une nouvelle étiquette à une note
...
- <kbd>⌘</kbd> + <kbd>⇧</kbd> + <kbd>A</kbd> permet de rechercher des actions
...
- <kbd>⌘</kbd> + <kbd>F</kbd> permet de rechercher dans la note actuelle
    - Utilisez les touches <kbd>Up</kbd> et <kbd>Down</kbd> ou les touches <kbd>F3</kbd> et <kbd>⇧</kbd> + <kbd>F3</kbd> pour passer aux correspondances précédentes et suivantes
    - <kbd>Esc</kbd> ferme la barre de recherche
...
- <kbd>⌘</kbd> + <kbd>⇧</kbd> + <kbd>L</kbd> ouvre une boîte de dialogue pour ajouter un lien vers une note
...
- <kbd>⌘</kbd> + <kbd>⇧</kbd> + <kbd>U</kbd> fait défiler les casses du texte sélectionné
- <kbd>Tab</kbd> indente le texte sélectionné (fonctionne également sur plusieurs lignes)
    - <kbd>⇧</kbd> + <kbd>Tab</kbd> désindente le texte sélectionné
- <kbd>Tab</kbd> après un caractère de liste non-ordonné l'indente
    - <kbd>⇧</kbd> + <kbd>Tab</kbd> après un caractère de liste non-ordonné le désindente
- <kbd>Entrée</kbd> dans les listes crée un nouvel élément de liste
- <kbd>⌘</kbd> + <kbd>Ctrl</kbd> + <kbd>Gauche</kbd> revient dans l'historique des notes
