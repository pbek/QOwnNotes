...
- <kbd>Alt</kbd> + <kbd>F</kbd> vous permet de rechercher des notes dans tous les tags / sous-dossiers
- <kbd>Alt</kbd> + <kbd>⇧ Maj</kbd> + <kbd>P</kbd> bascule vers la disposition précédente
...
- <kbd>Alt</kbd> + <kbd>Haut</kbd> passe à la note visible précédente
- <kbd>Alt</kbd> + <kbd>Bas</kbd> passe à la note visible suivante
...
- <kbd>Ctrl</kbd> + <kbd>⇧ Maj</kbd> + <kbd>D</kbd> active ou désactive le mode sans distractions
  - vous pouvez également le fermer avec <kbd>Échap</kbd>
...
- <kbd>Alt</kbd> + <kbd>⇧ Maj</kbd> + <kbd>A</kbd> ajoute un nouveau tag à une note
- <kbd>Ctrl</kbd> + <kbd>⇧ Maj</kbd> + <kbd>R</kbd> recharge le dossier de notes courant
- <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>F</kbd> permet de sélectionner un dossier de notes différent
- <kbd>Ctrl</kbd> + <kbd>⇧ Maj</kbd> + <kbd>S</kbd> recharge le moteur de scripts
...
- <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>⇧ Maj</kbd> + <kbd>A</kbd> permet de refaire l’action précédente
...
- <kbd>F7</kbd> passe au panneau des tags
...
- <kbd>Bas</kbd> or <kbd>Tab</kbd> place le focus sur la liste de notes
- <kbd>Entrée</kbd> crée une nouvelle note avec le texte de la barre de recherche comme titre

### Dans la liste des notes

- double-cliquez sur une note pour l'ouvrir dans un nouvel onglet (n'oubliez pas qu'il existe un hook de script qui peut redéfinir l'action de double-clic)
...
- <kbd>Ctrl</kbd> + <kbd>Clic</kbd> sur un lien pour l'ouvrir
- <kbd>Ctrl</kbd> + <kbd>F</kbd> vous permet de rechercher dans la note actuelle
  ...
  - <kbd>Échap</kbd> ferme la barre de recherche
...
- <kbd>Ctrl</kbd> + <kbd>D</kbd> duplique la ligne courante ou le texte sélectionné
  - <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>Bas</kbd> fait la même chose
- <kbd>Alt</kbd> + <kbd>Retour arrière</kbd> supprime la ligne courante
...
- <kbd>Alt</kbd> + <kbd>⇧ Maj</kbd> + <kbd>T</kbd> insère un tableau
...
- <kbd>Tab</kbd> après un caractère de liste non-ordonnée l'indente
...
- <kbd>Ctrl</kbd> + <kbd>+</kbd> augmente d'un point la taille de la police du texte de la note
- <kbd>Ctrl</kbd> + <kbd>-</kbd> diminue d'un point la taille de la police du texte de la note
...
- <kbd>Ctrl</kbd> + <kbd>⇧ Maj</kbd> + <kbd>H</kbd> insère un titre à partir du nom de fichier de la note en haut de cette dernière
...
- <kbd>Ctrl</kbd> + <kbd>S</kbd> enregistre la tâche actuelle
- <kbd>Ctrl</kbd> + <kbd>I</kbd> enregistre la tâche actuelle et l'insère dans la note actuelle
- <kbd>Ctrl</kbd> + <kbd>R</kbd> supprime la tâche actuelle
...
- <kbd>⌘ Cmd</kbd> + <kbd>⇧ Maj</kbd> + <kbd>F</kbd> permet de rechercher des notes (dans le nom de la note et dans son contenu)
- <kbd>⌃ Ctrl</kbd> + <kbd>F</kbd> permet de rechercher des notes dans tous les tags / sous-dossiers
- <kbd>⌃ Ctrl</kbd> + <kbd>⇧ Shift</kbd> + <kbd>P</kbd> bascule vers la disposition précédente
...
- <kbd>⌃ Ctrl</kbd> + <kbd>⇧ Maj</kbd> + <kbd>F</kbd> ouvre le dossier de la note actuelle dans Finder
...
- <kbd>⌘ Cmd</kbd> + <kbd>⇧ Maj</kbd> + <kbd>D</kbd> active ou désactive le mode sans distractions
  - vous pouvez également le fermer avec <kbd>Échap</kbd>
...
- <kbd>⌃ Ctrl</kbd> + <kbd>⇧ Maj</kbd> + <kbd>A</kbd> ajoute un nouveau tag à une note
...
- <kbd>⌘ Cmd</kbd> + <kbd>⌃ Ctrl</kbd> + <kbd>⇧ Maj</kbd> + <kbd>A</kbd> permet de refaire l’action précédente
...
- double-cliquez sur la note pour l'ouvrir dans un nouvel onglet (n'oubliez pas qu'il existe un hook de script qui peut redéfinir l'action de double-clic)
- <kbd>⌘ Cmd</kbd> + <kbd>A</kbd> sélectionne toutes les notes (pour les déplacer, les copier ou les supprimer avec un clic droit)
- <kbd>Tab</kbd> ou <kbd>Entrée</kbd> vous permet d'éditer la note actuelle

### Dans le panneau d'édition du texte de la note

- <kbd>⌘ Cmd</kbd> + <kbd>Clic</kbd> sur un lien pour l'ouvrir
...
- <kbd>⌘ Cmd</kbd> + <kbd>D</kbd> duplique la ligne courante ou le texte sélectionné
  - <kbd>⌘ Cmd</kbd> + <kbd>⌃ Ctrl</kbd> + <kbd>Bas</kbd> fait la même chose
...
- <kbd>⌃ Ctrl</kbd> + <kbd>⇧ Maj</kbd> + <kbd>T</kbd> insère un tableau
...
- <kbd>Tab</kbd> après un caractère de liste non-ordonnée l'indente
  - <kbd>⇧ Maj</kbd> + <kbd>Tab</kbd> après un élément de liste non-ordonnée le désindente
- <kbd>Entrée</kbd> dans les listes crée un nouvel élément de liste
- <kbd>⌘ Cmd</kbd> + <kbd>⌃ Ctrl</kbd> + <kbd>← Gauche</kbd> revient dans l'historique des notes
  - <kbd>⌘ Cmd</kbd> + <kbd>⌃ Ctrl</kbd> + <kbd>→ Droite</kbd> saute en avant dans l'historique des notes
...
- <kbd>⌘ Cmd</kbd> + <kbd>+</kbd> augmente d’un point la taille de la police du texte de la note
- <kbd>⌘ Cmd</kbd> + <kbd>-</kbd> diminue d’un point la taille de la police du texte de la note
...
- <kbd>⌘ Cmd</kbd> + <kbd>⇧ Maj</kbd> + <kbd>H</kbd> insère un titre à partir du nom de fichier de la note en haut de cette dernière
...
- <kbd>⌘ Cmd</kbd> + <kbd>S</kbd> enregistre la tâche actuelle
- <kbd>⌘ Cmd</kbd> + <kbd>I</kbd> enregistre la tâche actuelle et l'insère dans la note courante
- <kbd>⌘ Cmd</kbd> + <kbd>R</kbd> supprime la tâche actuelle
