...
::: tip
서버의 **앱 페이지** `https://<your-cloud-domain>/settings/apps`에서 `qownnotes`를 검색하여 **Nextcloud** 또는 **ownCloud** 인스턴스에서 직접 QOwnNotesAPI를 활성화할 수 있습니다.
...
::: tip
**Nextcloud** / **ownCloud** **sync client**를 사용하여 **노트를 동기화**합니다. 노트는 단순한 마크다운 파일입니다. 바퀴를 두 번 발명할 필요가 없습니다. 또한 다른 서비스를 사용하여 노트 파일 (예: Dropbox, Syncing 또는 Resilio Sync)을 동기화하는 사람들도 있습니다.
:::
