...
- QOwnNotes **یادداشت ها** را به طور مستقیم **به صورت پرونده های مارک داون در پوشه یادداشت** شما ذخیره می کند
- آن می تواند برای به اشتراک گذاری یادداشت ها به طور مستقیم با سرور نکست کلود یا اون کلود شما تعامل کند
...
- QOwnNotes یادداشت های و پرونده های واسطه یا پیوست شما را **همگام سازی نمی کند** چراکه همگام سازی پرونده یک فرآیند دشوار است و اکنون راه حل های مناسبی برای آن وجود دارد ([مشتری همگام سازی دسکتاپ نکست کلود](#nextcloud-desktop-sync-client) را ملاحظه کنید)
