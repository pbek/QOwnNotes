...
تنظیم نشانگر متن در ویرایش یادداشت کنونی برای موقعیت معین
---------------------------------------------------------------
...
شما باید متغیرهای تنظیماتتان را به صورت ویژگی های مشخص شده در اسکریپتتان تعریف کرده و آنها را در مشخصه ای با نام `متغیرهای تنظیمات` ثبت کنید.
