...
class ScriptingService : public QObject {
   ...
   public:
    ...
    Q_INVOKABLE void registerLabel(const QString &identifier,
                                   const QString &text = QString());

    Q_INVOKABLE void setLabelText(const QString &identifier,
                                  const QString &text);
    ...
    Q_INVOKABLE QString inputDialogGetItem(const QString &title,
                                           const QString &label,
                                           const QStringList &items,
                                           int current = 0,
                                           bool editable = false);

    Q_INVOKABLE QString inputDialogGetText(const QString &title,
                                           const QString &label,
                                           const QString &text = QString());
    ...
    Q_INVOKABLE QList<int> fetchNoteSubFoldersByParentId(int parentId);

    Q_INVOKABLE QString getSubFolderName(int id);
    ...
    Q_INVOKABLE void triggerMenuAction(
        const QString &objectName, const QString &checked = QString()) const;
