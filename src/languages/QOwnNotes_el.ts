...
(τουλάχιστον έκδοση QOWNNOTESAPI_MIN_VERSION) στον διακομιστή σας ownCloud, αν θέλετε τα QOwnNotes να έχουν πρόσβαση στις εκδόσεις σημειώσεων και τις σημειώσεις του κάδου απορριμάτων.</translation>
    ...
    <message>
        ...
        <translation type="vanished">Προειδοποιούμε ότι αυτό θα καταργήσει επίσης τα στοιχεία εκκρεμών εργασιών της κρυφής μνήμης και τους διαμορφωμένους φακέλους σημειώσεων και τις δέσμες ενεργειών!</translation>
    </message>
    <message>
