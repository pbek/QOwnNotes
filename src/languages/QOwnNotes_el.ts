...
Εάν ο κάδος απορριμμάτων είναι ενεργοποιημένος στον εξυπηρετητή ownCloud, θα πρέπει να μπορείτε να τα αποκαταστήσετε από εκεί.</numerusform>
    ...
    <message numerus="yes">
        ...
        <translation type="unfinished">
            <numerusform>Κατάργηση &lt;strong&gt; %n &lt;/ strong&gt; επιλεγμένου φακέλου &lt;ul&gt; &lt;li&gt; %1 &lt;/li&gt; &lt;/ul&gt; Όλα τα αρχεία και οι φάκελοι σε αυτούς τους φακέλους θα αφαιρεθούν επίσης!</numerusform>
...
Απλά δοκιμάστε τον εαυτό σας εάν λάβετε συγκρούσεις συγχρονισμού και ορίσετε υψηλότερη τιμή αν ναι.</translation>
    ...
    <message>
        ...
        <translation type="vanished">Προεπισκόπηση γραμματοσειρών</translation>
    </message>
    <message>
