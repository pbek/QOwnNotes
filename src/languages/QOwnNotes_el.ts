...
επαναφέρετε την τρέχουσα Σημείωση;</translation>
    ...
    <message numerus="yes">
        ...
        <translation type="obsolete">
            <numerusform>Να γίνει διαγραφή &lt;strong&gt;%n&lt;/strong&gt; συγκρουόμενων αντιγράφων βάσης δεδομένων τα οποία εμποδίζουν τη διαδικασία συγχρονισμού του ownCloud;</numerusform>
