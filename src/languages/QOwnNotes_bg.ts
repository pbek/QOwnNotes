...
Просто се тествайте, ако получавате конфликти при синхронизиране и задайте по-висока стойност, ако е така.</translation>
    ...
    <message>
        ...
        <translation type="vanished">Бъдете предупредени, че това ще премахне и вашите кеширани елементи на todo и конфигурирани папки и скриптове за бележки!</translation>
    </message>
    <message>
