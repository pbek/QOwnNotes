...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Если вы хотите иметь возможность получить доступ к версиям и корзине заметок на вашем сервере ownCloud, можно настроить QOwnNotes прямо сейчас. Также можете сделать это в дальнейшем.</translation>
    </message>
    <message>
        <source>In any case you need the ownCloud sync client (or any other sync client) to sync your notes with your ownCloud server.</source>
        <translation type="vanished">В любом случае вам нужен клиент синхронизации ownCloud (или любой другой) для синхронизации заметок с вашим сервером ownCloud.</translation>
    </message>
    <message>
