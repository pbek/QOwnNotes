...
Если на сервере ownCloud включена корзина, то заметки можно будет восстановить из неё.</numerusform>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Папка с именем &lt;b&gt;%1&lt;/b&gt; не может быть создана, потому что она находится в списке игнорируемых подпапок! Вы можете изменить это в &lt;i&gt;Настройках панелей&lt;/i&gt;.</translation>
    </message>
  </context>
  <context>
