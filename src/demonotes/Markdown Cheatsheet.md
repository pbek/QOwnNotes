...
This Markdown cheatsheet is intended as a quick reference and showcase of the Markdown syntax in [QOwnNotes](https://www.qownnotes.org).
...
You can use the shortcut <kbd>Ctrl + B</kbd> for making text bold and <kbd>Ctrl + I</kbd> for making it italic.
...
You can use the shortcut <kbd>Ctrl + U</kbd> to underline a text.
...
You can use the shortcut <kbd>Alt + Shift + S</kbd> to strike out a text.
...
You can use the shortcut <kbd>Ctrl + L</kbd> to **create links to webpages or other notes**.
...
The following examples use a placeholder path. Insert an image into a real note with <kbd>Ctrl + Shift + I</kbd> or paste one with <kbd>Ctrl + Shift + V</kbd> to see it rendered here.
...
The image can also be in the clipboard, the insert-image dialog will detect it and show a preview.
...
You can use the shortcut <kbd>Ctrl + Shift + C</kbd> on selected inline text or just inside of text to create an inline code block.
...
You can use the shortcut <kbd>Ctrl + Shift + C</kbd> on multiple selected lines of text or in an empty line to create a code block.
...
Press <kbd>Alt + Shift + T</kbd> to activate a dialog that can help you to create tables. You can even import CSV files in that dialog.
...
You can use the shortcut <kbd>Ctrl + Shift + B</kbd> for marking text as blockquote.
