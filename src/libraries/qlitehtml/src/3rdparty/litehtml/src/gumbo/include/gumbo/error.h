...
extern "C"
{
	...
	void gumbo_caret_diagnostic_to_string(struct GumboInternalParser* parser, const GumboError* error,
	...
	void gumbo_print_caret_diagnostic(struct GumboInternalParser* parser, const GumboError* error,
