    ...
    ui(new Ui::TrashDialog)
{
	...
	button->setToolTip( tr("<h3>Slower, but with note versions</h3>"
						   "<p>The note will be restored on your ownCloud server with all versions.</p>"
						   "<p>You will have to wait until it is synced to QOwnNotes by ownCloud sync.</p>" ));
	...
	button->setToolTip( tr("<h3>Faster, but without versions</h3>"
						   ...
						   "<p>The note versions on your ownCloud server will not be restored and the note will remain in the trash.</p>"
