...
Build-Depends: debhelper (>= 4.1.16), cdbs, xz-utils, qt5-qmake, cmake, qtbase5-dev, libqt5svg5-dev, qtdeclarative5-dev, libqt5websockets5-dev, libqt5x11extras5-dev, libaspell-dev
Package-List:
