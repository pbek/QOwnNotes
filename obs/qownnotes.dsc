...
Build-Depends: debhelper (>= 4.1.16), cdbs, xz-utils, qt5-qmake, qtbase5-dev, libqt5svg5-dev, qtdeclarative5-dev, libqt5xmlpatterns5-dev, libqt5websockets5-dev, libaspell-dev
Package-List:
